...
func (fs *FileSystemMemory) Init() {
	...
	fs.services = make(map[string]*models.ServerService)
...
func (fd *FileSystemMemory) AddService(srv *models.ServerService) error {
...
func (fd *FileSystemMemory) EditService(srv *models.ServerService) error {
	if fd.IsService(srv.Id) {
		fd.services[srv.Id] = srv
...
func (fd *FileSystemMemory) GetServices() []*models.ServerService {
	return utitlity.MapGetValues(fd.services)
}

func (fd *FileSystemMemory) GetService(id string) *models.ServerService {
	return fd.services[id]
}

// Retrieves all active services
func (fs *FileSystemMemory) getActiveServicesFromFile() ([]*models.ServerService, error) {
...
func (fs *FileSystemMemory) getServicesFromFile() ([]*models.ServerService, error) {
	files, err := os.ReadDir(fs.storagePath)
	if err != nil {
		return nil, err
	}
...
func (fs *FileSystemMemory) saveServiceOnFile(srv *models.ServerService) error {
...
func (fs *FileSystemMemory) getServiceFromFile(id string) (*models.ServerService, error) {
